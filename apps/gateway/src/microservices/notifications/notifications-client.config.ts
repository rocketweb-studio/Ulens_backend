...
export class NotificationsClientEnvConfig {
	@IsString()
	@IsNotEmpty({
		message: "Set Env variable NOTIFICATIONS_TCP_HOST, example: localhost",
	})
	...
	constructor(private configService: ConfigService<any, true>) {
		this.notificationsClientHost = this.configService.get<string>("NOTIFICATIONS_TCP_HOST");
		this.notificationsClientPort = this.configService.get<number>("NOTIFICATIONS_TCP_PORT");
