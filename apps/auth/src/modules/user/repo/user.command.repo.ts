	...
	async createUser(userDto: User): Promise<RegistrationResultView> {
		try {
			...
			return {
				...
				// todo: fix this
				//biome-ignore lint/style/noNonNullAssertion: <asd>
			...
			throw new UnexpectedErrorRpcException(
				"During the registration occured unexpected error",
			);
		}
	}
