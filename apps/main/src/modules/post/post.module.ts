...
import { PrismaPostCommandRepository } from "@main/modules/post/infrastructure/post.command.repository";
import { PrismaPostQueryRepository } from "@main/modules/post/infrastructure/post.query.repository";
