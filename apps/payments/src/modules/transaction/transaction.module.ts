...
import { TransactionCommandRepository } from "@payments/modules/transaction/infrastructure/transaction.command.repository";
import { TransactionQueryRepository } from "@payments/modules/transaction/infrastructure/transaction.query.repository";
...
import { InboxCommandRepository } from "@payments/modules/event-store/infrastructure/inbox.command.repository";
