...
- **[Брокер сообщений(подробно)](./docs/rabbit/rabbit.md)** и **[Брокер сообщений(кратко)](./docs/rabbit/rabbit-short.md)** - Описание интеграции брокеров сообщений в проекте
