...
export class AuthClientController {
  ...
  @ApiOkResponse({ description: 'User was successfully logged in', type: AccessTokenDto })
  ...
  @ApiOkResponse({ description: 'Token pair was successfully refreshed', type: AccessTokenDto })
