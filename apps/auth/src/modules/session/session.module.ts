...
@Module({
  ...
  providers: [
    SessionService,
    { provide: ISessionCommandRepository, useClass: PrismaSessionCommandRepository },
    { provide: ISessionQueryRepository, useClass: PrismaSessionQueryRepository }
  ],
  exports: [SessionService, { provide: ISessionQueryRepository, useClass: PrismaSessionQueryRepository }]
})
