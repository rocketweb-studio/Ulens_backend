...
import { PrismaLikeCommandRepository } from "@main/modules/like/infrastructure/like.command.repository";
import { LikeController } from "@main/modules/like/like.controller";
import { PrismaLikeQueryRepository } from "@main/modules/like/infrastructure/like.query.repository";
@Module({
	imports: [],
	providers: [
